...
public class Number implements Validator<String> {
  ...
  /**
   * Helper method to check that a given string, when converted to a number, only has two decimal places
   * @param input - User input to be checked as a string
   * @return - true or false
   */
   ...
   * A string must be able to be converted to a number, less than 10 digits, and have less than two decimal places
